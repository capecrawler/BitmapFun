...
public class ImageCache {
    ...
    private byte[] reusableLock = new byte[0];
                ...
                protected void entryRemoved(boolean evicted, String key,
                    ...
                    if (RecyclingBitmapDrawable.class.isInstance(oldValue)) {
                        ...
                        if (Utils.hasHoneycomb()) {
                        	...
                        	if (InBitmapDrawable.class.isInstance(oldValue)) {
                        		((InBitmapDrawable) oldValue).setIsCached(false);
	                        	if (((InBitmapDrawable) oldValue).inBitmapSafe()){	                        	
		                        	synchronized (reusableLock) {
    ...
    public void addBitmapToCache(String data, BitmapDrawable value) {
        ...
        if (mMemoryCache != null) {
            ...
            }else if (InBitmapDrawable.class.isInstance(value)){
            	((InBitmapDrawable) value).setIsCached(true);
            }
